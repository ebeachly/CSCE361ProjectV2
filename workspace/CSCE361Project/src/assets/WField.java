...
public class WField extends Location {
	...
	public WField() {
		...
		this.north = new CardinalDirection("north", null, "To the north there is a field with a wagon.");
		this.east = new CardinalDirection("east", null, "To the east the road leads toward a house.");
		this.south = new CardinalDirection("south", World.swField, "To the south there is an empty field.");
		this.west = new CardinalDirection("west", null, "To the west there is a bridge toward a castle.");
